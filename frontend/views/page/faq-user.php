    ...
    <div class="container">
        ...
        <div class="faq-content">
            <div class="tab-control">
                <a href="<?= Yii::$app->urlManager->createUrl(['page/show-single','slug' => 'faq-user']) ?>" class="bnt-user active">User</a>
                <a href="<?= Yii::$app->urlManager->createUrl(['page/show-single','slug' => 'faq-parker']) ?>" class="btn-parker">Parker</a>
            </div>
            <div class="tab-content">
                <div class="tab-item " id="tab-parker">
